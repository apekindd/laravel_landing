                        ...
                        <div class="inner_section">
                            <div class="row">
                                ...
                                <div class=" col-lg-7 col-md-7 col-sm-7 col-xs-12 pull-left">
                                    ...
                                    <div class="work_bottom"> <span>Want to know more..</span> <a href="{{ route('page', ['alias'=>$page->alias]) }}" class="contact_btn">Contact Us</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container">
        ...
        <div class="team_section clearfix">
                ...
                <div class="team_area">
                    ...
                    <h3 class="wow fadeInDown delay-0{{ $k*3 + 2 }}s">{{ $item->name }}</h3>
                    <span class="wow fadeInDown delay-0{{ $k*3 + 2 }}s">{{ $item->position }}</span>
                    <p class="wow fadeInDown delay-0{{ $k*3 + 2 }}s">
                        {{ $item->text }}
                    </p>
                </div>
            @endforeach
